        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-r from-blue-400 to-blue-600 text-white p-4 rounded-lg">
              <div className="text-2xl font-bold">
                {compliances.filter(c => c.Compliance_Status === 'Under Review').length}
              </div>
          ...
          <div className="overflow-x-auto">
            {compliances.length === 0 ? (
              <div className="text-center py-12">
                <div className="text-gray-500 mb-4">No compliance records found</div>
                {isAdmin && user?.propertyId && (
                  <button
                    onClick={() => handleAdd()}
                    ...
                    <tr key={compliance.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          compliance.Compliance_Status === 'Under Review' ? 'bg-yellow-100 text-yellow-800' :
