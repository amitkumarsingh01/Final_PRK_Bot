...
import { Pencil, Trash2, Plus, Save, X, Building, Eye, Users, Calendar, FileText, CheckCircle, AlertTriangle, Zap } from 'lucide-react';
...
const ElectricalWorkPage: React.FC = () => {
  ...
  const handleAdd = () => {
    setEditModal({ open: true, record: { ...emptyElectricalWorkPermit, property_id: selectedPropertyId }, isNew: true });
  };
