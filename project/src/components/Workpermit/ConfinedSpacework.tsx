...
const ConfinedSpaceWorkPage: React.FC = () => {
  ...
  const fetchData = async (propertyId: string) => {
    try {
      ...
      setError('Failed to fetch confined space work permits');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleAdd = () => {
    setEditModal({ open: true, record: { ...emptyConfinedSpaceWorkPermit, property_id: selectedPropertyId }, isNew: true });
  };
