        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr style={{ background: orange, color: '#fff' }}>
              ...
              <th className="px-3 py-2 border">Fire Hazards Identified</th>
                  ...
                  <tr>
                    <td colSpan={10} className="text-center py-6">
                      <div className="flex items-center justify-center gap-3">
                        <span>No site assessment records found</span>
                        {isAdmin && (
                          <button onClick={() => handleAdd()} className="ml-2 px-3 py-1 rounded bg-gradient-to-r from-[#E06002] to-[#FB7E03] text-white font-semibold shadow">Add Site Assessment</button>
                        )}
                      </div>
                    </td>
                  </tr>
          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
              <div className="grid grid-cols-2 gap-3">
                ...
                <textarea className="border rounded px-3 py-2 col-span-2" placeholder="Risk Areas" value={editModal.item.Risk_Areas} onChange={e => setEditModal(m => m && { ...m, item: { ...m.item!, Risk_Areas: e.target.value } })} required />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="col-span-2"><b>Risk Areas:</b> {viewModal.item.Risk_Areas}</div>
