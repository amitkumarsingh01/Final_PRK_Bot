          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={e => { e.preventDefault(); handleSave(); }}>
              <div className="grid grid-cols-2 gap-3">
                ...
                <input className="border rounded px-3 py-2" placeholder="Equipment Type" value={editModal.item.Equipment_Type} onChange={e => setEditModal(m => m && { ...m, item: { ...m.item!, Equipment_Type: e.target.value } })} required />
