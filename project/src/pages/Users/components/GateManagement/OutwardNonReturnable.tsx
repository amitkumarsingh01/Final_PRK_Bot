...
const COutwardNonReturnablePage: React.FC = () => {
  console.log('?? OutwardNonReturnable: Component initialized');
  const { user } = useAuth();
  console.log('?? OutwardNonReturnable: User loaded', { userId: user?.userId });
...
export default COutwardNonReturnablePage;
