...
// import { AlertCircle, Check, Edit, Plus, Trash2, RefreshCw, ChevronDown, ChevronUp, Droplets } from 'lucide-react';
...
// const initialWaterSourceForm: WaterSourceForm = {
//   name: '',
//   source_type: 'BWSSB',
//   location: '',
//   description: '',
...
// const initialWaterReadingForm: WaterReadingForm = {
//   water_source_id: '',
//   reading_type: 'intake',
//   value: 0,
//   unit: 'KL',
...
//   // Form states
//   const [sourceForm, setSourceForm] = useState<WaterSourceForm>(initialWaterSourceForm);
//   const [readingForm, setReadingForm] = useState<WaterReadingForm>(initialWaterReadingForm);
...
//   // Fetch water sources on component mount
//   useEffect(() => {
//     fetchWaterSources();
...
//     if (selectedSource) {
//       setReadingForm({
//         ...initialWaterReadingForm,
//         water_source_id: selectedSource.id,
//         property_id: selectedSource.property_id
//       });
//     }
//   }, [selectedSource]);
...
//     setLoading(true);
//     try {
//       let url = `${API_BASE_URL}/water-sources/?`;
...
//     try {
//       const response = await fetch(`${API_BASE_URL}/water-sources/${sourceId}/readings`);
...
//       setSourceForm(initialWaterSourceForm);
...
//                         <span className="mr-2">{source.source_type}</span>
//                         <span className={`px-2 py-0.5 rounded-full text-xs ${source.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
...
//                           <strong>Location:</strong> {source.location || 'Not specified'}
//                         </p>
//                         <p className="text-sm text-gray-600">
//                           <strong>Description:</strong> {source.description || 'No description available'}
//                         </p>
...
//                           <h4 className="font-semibold">Water Readings</h4>
//                           <button
//                             onClick={() => {
//                               setReadingForm({
//                                 ...initialWaterReadingForm,
...
//                             }}
//                             className="bg-[#DB7723] text-white px-3 py-1 rounded-md text-sm hover:bg-[#DD6A1A] transition flex items-center"
//                           >
//                             <Plus className="w-3 h-3 mr-1" /> Add Reading
//                           </button>
//                         </div>
                        
//                         {isAddingReading && readingForm.water_source_id === source.id && (
...
//                             >
//                               <div>
//                                 <label htmlFor="reading_type" className="block text-xs font-medium text-gray-700 mb-1">Reading Type *</label>
//                                 <select
//                                   id="reading_type"
//                                   value={readingForm.reading_type}
//                                   onChange={(e) => setReadingForm({ ...readingForm, reading_type: e.target.value })}
//                                   className="w-full border border-gray-300 rounded-md p-1.5 text-sm focus:ring-[#F88024] focus:border-[#F88024]"
//                                   required
//                                 >
...
//                               <div>
//                                 <label htmlFor="reading_date" className="block text-xs font-medium text-gray-700 mb-1">Reading Date</label>
//                                 <input
//                                   type="date"
//                                   id="reading_date"
...
//                                   className="bg-gray-300 text-gray-800 px-3 py-1 rounded-md text-sm hover:bg-gray-400 transition"
//                                 >
//                                   Cancel
//                                 </button>
//                                 <button
//                                   type="submit"
//                                   className="bg-[#DF5F0D] text-white px-3 py-1 rounded-md text-sm hover:bg-[#DD6A1A] transition"
//                                 >
//                                   Add Reading
//                                 </button>
//                               </div>
...
//                           <p className="text-sm text-gray-500 italic">No readings available for this water source.</p>
//                         ) : (
...
//                                         reading.reading_type === 'intake' ? 'text-blue-600' :
//                                         reading.reading_type === 'yield' ? 'text-green-600' : 'text-orange-600'
//                                       }`}>
...
//                                       <button
//                                         onClick={() => deleteWaterReading(reading.id)}
...
import { useState, useEffect } from 'react';
import { AlertCircle, Check, Edit, Plus, Trash2, RefreshCw, ChevronDown, ChevronUp, Droplets, Calendar } from 'lucide-react';
