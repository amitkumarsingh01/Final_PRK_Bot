...
const UserPropertyIncidentReportPage: React.FC = () => {
  ...
  // Fetch incident reports for user's property
  const fetchData = async () => {
    ...
    try {
      ...
      const items: IncidentReport[] = res.data || [];
...
export default UserPropertyIncidentReportPage;
