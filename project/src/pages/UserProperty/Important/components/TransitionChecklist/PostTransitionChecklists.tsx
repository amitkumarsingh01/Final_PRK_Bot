...
const UserPropertyPostTransitionChecklistsPage: React.FC = () => {
  const { user } = useAuth();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between">
            ...
            {/* Edit Site button available for UserProperty users - Add Item removed */}
            <div className="flex space-x-3">
              ...
              {/* Add Item button removed for UserProperty - edit-only access */}
            </div>
          </div>
        </div>
...
export default UserPropertyPostTransitionChecklistsPage;
