...
import { Pencil, Trash2, Plus, Save, X, Building, Eye, Users, Calendar, FileText, CheckCircle, AlertTriangle, Shovel } from 'lucide-react';
...
const ExcavationPermitPage: React.FC = () => {
  ...
  const handleAdd = () => {
    setEditModal({ open: true, record: { ...emptyExcavationPermit, property_id: selectedPropertyId }, isNew: true });
  };
