...
const CMoveOutCoordinationPage: React.FC = () => {
  console.log('🚀 MoveOutCoordination: Component initialized');
  const { user } = useAuth();
  console.log('👤 MoveOutCoordination: User loaded', { userId: user?.userId });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editModal.isNew) {
        newArr = [...report.move_out_coordinations, editModal.item];
      } else {
...
export default CMoveOutCoordinationPage; 
