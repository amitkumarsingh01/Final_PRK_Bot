...
class Property(Base):
    ...
    activities = relationship("ActivityModel", back_populates="property", cascade="all, delete-orphan")  # Add activities relationship
...
class ActivityModel(Base):
    ...
    property_id = Column(String, ForeignKey("properties.id"), nullable=False)  # Add property_id field
    
    # Relationship with tasks
    tasks = relationship("TaskModel", back_populates="activity", cascade="all, delete-orphan")
    # Add relationship with property
...
class ActivityBase(BaseModel):
    ...
    property_id: str  # Add property_id to base model
